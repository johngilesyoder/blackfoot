...
<tr>
  <td class="accessory-option">
    <input type="checkbox" class="accessory-checkbox" name="accessory" data-title="<?php echo $brand . '&nbsp;'; ?><?php the_title(); ?>" data-item="<?php echo $product->id;?>" data-price="0.00" data-price-each="<?php echo $price ?>" value="Boat Accessory">
  </td>
