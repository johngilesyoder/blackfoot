...
<?php if ( $order = $booking->get_order() ) : ?>
  ...
  <?php if ( $order->status == 'pending' ) : ?>
    <p style="padding-top: 15px;"><?php printf( __( 'To pay for this booking, please use the following link: %s', 'woocommerce-bookings' ), '<a style="font-weight:700;color:#418AAA;" href="' . esc_url( $order->get_checkout_payment_url() ) . '">' . __( 'Pay for booking', 'woocommerce-bookings' ) . '</a>' ); ?></p>
  <?php endif; ?>
