...
if ( typeof define === 'function' && define.amd ) {
  ...
  window.Enviratope.Item = itemDefinition(
    window.Outlayer
  );
}
...
if ( typeof define === 'function' && define.amd ) {
  ...
  // browser global
  window.Enviratope = window.Enviratope || {};
  window.Enviratope.LayoutMode = layoutModeDefinition(
    window.getSize,
    window.Outlayer
  );
}
...
// used for AMD definition and requires
function enviratopeDefinition( Outlayer, getSize, matchesSelector, Item, LayoutMode ) {
  // create an Outlayer layout class
...
if ( typeof define === 'function' && define.amd ) {
  ...
  // CommonJS
  module.exports = enviratopeDefinition(
    require('outlayer'),
    require('get-size'),
    require('desandro-matches-selector'),
    require('./item'),
  ...
  // browser global
  window.Enviratope = enviratopeDefinition(
    window.Outlayer,
    window.getSize,
    window.matchesSelector,
