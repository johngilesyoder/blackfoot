            ...
            $.post(
                ...
                function( response ) {
                    ...
                    if ( response && response.success ) {
                        ...
                        // Init each QuickTag tool for the meta modal editor
                        ...
                        $( '#envira-gallery-output' ).trigger({ type: 'enviraRefreshed', html: response.success, id: envira_gallery_metabox.id });
                    }
                },
                'json'
            );
