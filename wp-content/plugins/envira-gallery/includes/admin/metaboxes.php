...
class Envira_Gallery_Metaboxes {
    ...
    public function meta_box_styles() {
        ...
        // Only load if we are adding or editing a Post Type
        $screen = get_current_screen();
        if ( $screen->base !== 'post' && $screen->post_type !== 'envira' ) {
            return;
        }
											...
											<div id="search-panel">
												<div class="link-search-wrapper">
													<label class="setting" for="search-field">
														<input type="search" id="wp-link-search" class="link-search-field" autocomplete="off" placeholder="<?php _e( 'Search WordPress Content for URL', 'envira-gallery' ); ?>" />
													</label>
												</div>
